...
curl -sL "https://github.com/derailed/k9s/releases/download/v${K9S_VERSION}/k9s_Linux_${GOARCH}.tar.gz" -o /tmp/k9s.tar.gz
tar xf /tmp/k9s.tar.gz -C /tmp/ k9s
sudo mv /tmp/k9s "$PREFIX/"
rm -f /tmp/k9s.tar.gz
